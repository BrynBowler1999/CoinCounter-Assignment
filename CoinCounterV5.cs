...
namespace Coin_Counter
{
    public partial class MoneyCreditCounterV5 : Form
    {
        ...
        private void btn_CalculateCredits_Click(object sender, EventArgs e)
        {
            double CreditCost = Convert.ToInt32(textbox_CreditCost.Text);
            double Total = Convert.ToDouble(textbox_Total.Text);
            double CreditTotal = (Total / CreditCost);
            textbox_CreditTotal.Text = CreditTotal.ToString();
        }
